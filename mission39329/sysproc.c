...
)
{
	...
	fprintf(StdHandle, "ds:Thread functions. Access the specified track on the floppy disk.\n");
	fprintf(StdHandle, "rr:Thread functions.\n");
	fprintf(StdHandle, "loop:Dead-loop thread functions.\n");
	...
	fprintf(StdHandle, "sd:Scan the floppy disk and output the relevant information.\n");
	fprintf(StdHandle, "dir:Prints information about the root Chinese of the floppy disk.\n");
	fprintf(StdHandle, "help:help message.\n");
